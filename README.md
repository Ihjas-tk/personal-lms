...
A self-built learning system for a 40-week track in LLM engineering and AI evaluation, plus the research that shaped it.

| Where | What |
|---|---|
| [`learn/`](learn/) | The app: a local, file-first study tracker (FastAPI + React). Start with `cd learn && uv run learn`. See its [README](learn/README.md). |
| [`llm-evals-track.md`](llm-evals-track.md) | The 40-week curriculum the app is seeded from. |
| [`research/sources/`](research/sources/) | Eleven cited research reports: job demand, forecasts, practitioner signal, learning paths, curricula, oil & gas projects, learning science, UX patterns, stack options. |
| [`docs/superpowers/`](docs/superpowers/) | The app's design spec and the redesign implementation plan. |
| [`learn/docs/ux/`](learn/docs/ux/) | The UX brief, screenshots before and after, and the Claude Design handoff. |

The learner's own notes, attempts and sessions live in `learn/vault/`, which is a separate local git repo and is not part of this one.

---

# AI & Data Skills Map, 2026–2030

Research compiled 2026-09-18 from four independent evidence angles (job-posting data, analyst forecasts, practitioner voice, learning-path evidence). Full source reports with citations live in [`research/sources/`](research/sources/).

> **Personal track (added 2026-09-18):** with an MSc in Data Science (2022) and oil and gas domain experience, stages 0–3 below are skipped. The detailed LLM engineering + AI evals curriculum, the 40-week calendar, and the oil and gas project spine are in [llm-evals-track.md](llm-evals-track.md).
